...
// data->philos[i].time_to_die); 		printf("philos time to eat= %zu\n",
// data->philos[i].time_to_eat); 		printf("philos time to sleep= %zu\n",
// data->philos[i].time_to_sleep); 		printf("philos time start= %zu\n",
// data->philos[i].start_time); 		if (i == data->philos[i].number_of_philos - 1)
// 			printf("data chopsticks (%p) vs right chopstick (%p)\n",
// 				&data->chopsticks[0],
// data->philos[i].right_chopstick); 		else 			printf("data chopsticks (%p) vs right
// chopstick (%p)\n", 				&data->chopsticks[i + 1],
// data->philos[i].right_chopstick); 		printf("data chopsticks (%p) vs left
// chopstick (%p)\n", 			&data->chopsticks[i], data->philos[i].left_chopstick);
// 		printf("philos number of philos= %u\n",
// 			data->philos[i].number_of_philos);
// 		printf("philos number of times to eat = %i\n",
